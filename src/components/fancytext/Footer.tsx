      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="relative z-20">
            <h2 className="text-2xl font-bold mb-4 text-yellow-400">Community</h2>
            <ul className="space-y-2 text-yellow-500 hover:text-yellow-300">
          ...
          <div>
            <h2 className="text-2xl text-yellow-400 font-bold mb-4">About Lunar Boom</h2>
            <ul className="space-y-2 text-yellow-500 hover:text-yellow-300">
          ...
          <div>
            <h2 className="text-2xl text-yellow-400 font-bold mb-4">Buy and Sell Music</h2>
            <ul className="space-y-2 text-yellow-500 hover:text-yellow-300">
          ...
          <div>
            <h2 className="text-2xl text-yellow-400 font-bold mb-4">Help</h2>
            <ul className="space-y-2 text-yellow-500 hover:text-yellow-300">
