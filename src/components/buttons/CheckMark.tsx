...
const Checkmark = () => {
  const id = useId(); // Generate a unique ID for each checkbox

  return (
    <StyledWrapper>
      <div className="checkbox-wrapper">
        <input id={`_checkbox-${id}`} type="checkbox" />
        <label htmlFor={`_checkbox-${id}`}>
...
const StyledWrapper = styled.div`
  ...
  .checkbox-wrapper label {
    ...
    background-image: linear-gradient(43deg, #F2E200 0%, #F2D800 46%, #F59E0B 100%);
    border-radius: 50%;
